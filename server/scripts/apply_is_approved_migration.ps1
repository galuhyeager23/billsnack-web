# Apply is_approved migration to products table
# Run this script from server/ directory

$ErrorActionPreference = "Stop"

Write-Host "=======================================" -ForegroundColor Cyan
Write-Host "Apply is_approved Migration" -ForegroundColor Cyan
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host ""
...
$MIGRATION_FILE = "models\add_is_approved_to_products.sql"
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "  1. Added is_approved column to products table" -ForegroundColor Gray
        Write-Host "  2. Set default approved for all existing products" -ForegroundColor Gray
    } else {
